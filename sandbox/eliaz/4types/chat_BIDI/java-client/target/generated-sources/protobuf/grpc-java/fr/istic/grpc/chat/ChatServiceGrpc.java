...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<fr.istic.grpc.chat.Chat.ChatMessage,
      fr.istic.grpc.chat.Chat.ChatMessage> getJoinChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "joinChat",
      requestType = fr.istic.grpc.chat.Chat.ChatMessage.class,
      responseType = fr.istic.grpc.chat.Chat.ChatMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<fr.istic.grpc.chat.Chat.ChatMessage,
      fr.istic.grpc.chat.Chat.ChatMessage> getJoinChatMethod() {
    io.grpc.MethodDescriptor<fr.istic.grpc.chat.Chat.ChatMessage, fr.istic.grpc.chat.Chat.ChatMessage> getJoinChatMethod;
    if ((getJoinChatMethod = ChatServiceGrpc.getJoinChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getJoinChatMethod = ChatServiceGrpc.getJoinChatMethod) == null) {
          ChatServiceGrpc.getJoinChatMethod = getJoinChatMethod =
              io.grpc.MethodDescriptor.<fr.istic.grpc.chat.Chat.ChatMessage, fr.istic.grpc.chat.Chat.ChatMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "joinChat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fr.istic.grpc.chat.Chat.ChatMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<fr.istic.grpc.chat.Chat.ChatMessage> joinChat(
        io.grpc.stub.StreamObserver<fr.istic.grpc.chat.Chat.ChatMessage> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getJoinChatMethod(), responseObserver);
    }
  }
  ...
  public static final class ChatServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<fr.istic.grpc.chat.Chat.ChatMessage> joinChat(
        io.grpc.stub.StreamObserver<fr.istic.grpc.chat.Chat.ChatMessage> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              fr.istic.grpc.chat.Chat.ChatMessage,
              fr.istic.grpc.chat.Chat.ChatMessage>(
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return fr.istic.grpc.chat.Chat.getDescriptor();
    }
