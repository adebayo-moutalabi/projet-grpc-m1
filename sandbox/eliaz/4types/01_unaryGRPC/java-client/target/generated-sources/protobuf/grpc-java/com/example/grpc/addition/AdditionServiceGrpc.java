...
public final class AdditionServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "addition.AdditionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.addition.AddRequest,
      com.example.grpc.addition.AddResponse> getAddMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Add",
      requestType = com.example.grpc.addition.AddRequest.class,
      responseType = com.example.grpc.addition.AddResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.addition.AddRequest,
      com.example.grpc.addition.AddResponse> getAddMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.addition.AddRequest, com.example.grpc.addition.AddResponse> getAddMethod;
      ...
      synchronized (AdditionServiceGrpc.class) {
        if ((getAddMethod = AdditionServiceGrpc.getAddMethod) == null) {
          AdditionServiceGrpc.getAddMethod = getAddMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.addition.AddRequest, com.example.grpc.addition.AddResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Add"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.addition.AddRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.addition.AddResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void add(com.example.grpc.addition.AddRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.addition.AddResponse> responseObserver) {
  ...
  public static final class AdditionServiceStub
    ...
    /**
     */
    public void add(com.example.grpc.addition.AddRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.addition.AddResponse> responseObserver) {
  ...
  public static final class AdditionServiceBlockingStub
    ...
    /**
     */
    public com.example.grpc.addition.AddResponse add(com.example.grpc.addition.AddRequest request) {
  ...
  public static final class AdditionServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.addition.AddResponse> add(
        com.example.grpc.addition.AddRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD:
          serviceImpl.add((com.example.grpc.addition.AddRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.addition.AddResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.grpc.addition.AddRequest,
              com.example.grpc.addition.AddResponse>(
  ...
  private static abstract class AdditionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.addition.AdditionProto.getDescriptor();
    }
